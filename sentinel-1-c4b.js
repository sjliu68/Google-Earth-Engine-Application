...
Export.image.toDrive(
  {
    image: compositeClippedAsVH,
    description: 'Sentinel_as_VH_'+year+month,
    scale: 10,
    fileFormat: 'GeoTIFF',
...
Export.image.toDrive(
  {
    image: compositeClippedAsVV,
    description: 'Sentinel_as_VV_'+year+month,
    scale: 10,
    fileFormat: 'GeoTIFF',
    maxPixels: 3784216672400,
    region: studyArea
...
Export.image.toDrive(
  {
    image: compositeClippedDesVH,
    description: 'Sentinel_des_VH_'+year+month,
    scale: 10,
    fileFormat: 'GeoTIFF',
    maxPixels: 3784216672400,
    region: studyArea
...
Export.image.toDrive(
  {
    image: compositeClippedDesVV,
    description: 'Sentinel_des_VV_'+year+month,
    scale: 10,
    fileFormat: 'GeoTIFF',
    maxPixels: 3784216672400,
    region: studyArea
